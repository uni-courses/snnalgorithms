...
, and a boolean per graph to indicate whether the graphs as computed by
Alipour and the SNN match.
...
def find_majority(*, votes: List[float], position: int) -> Tuple[float, int]:
    ...
    Negatives may be removed because they are from inhibited counter
    neurons.
