...
def spike_once_xy(
    ...
    x = dx_node * 1 + plot_config.dx_redundant * node_redundancy
    y = dy_node * (2 * node_index) + plot_config.dy_redundant * node_redundancy
    return x, y
...
def degree_receiver_xy(
    ...
    y = dy_node * (2 * node_index + 1) + plot_config.dy_redundant * (
        node_redundancy + degree_index_per_circuit
    )
    return x, y
...
def terminating_xy(
    ...
    y = dy_node * (+1) + plot_config.dy_redundant * node_redundancy
    return x, y
