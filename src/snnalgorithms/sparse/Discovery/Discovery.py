...
class Discovery_algo:
                    ...
                    for bias in [
                        ...
                        * (disco.bias_max - disco.bias_min)
                        ...
                        if self.is_expected_neuron_I(
                            lif_neuron=lif_neuron, max_time=max_time
                        ):
    ...
    def is_expected_neuron_I(
        self, lif_neuron: LIF_neuron, max_time: int
    ) -> bool:
        ...
        snn_graph.nodes[0]["nx_lif"] = [lif_neuron]
